...
var LoaderBase = new Class({
    ...
    canLoadType: function(type) {
        ...
        // nee to open for ff so it doesn't fail
     ...
     *
     * The second parameter is a String which will be used to determine if content should be cacheIDd in memory
        ...
        if (LoaderCache.hasFile(this.url)) {
            ...
            if (this.loadType != LoaderBase.typeText) {
                ...
                if (!this.loadTypeSet && (this.loadType == LoaderBase.typeBlob ||
                    ...
                    thi.xhr.overrideMimeType('text/plain; charset=x-user-defined');
                }
            }
            ...
            switch (this.loadType) {
                ...
                case LoaderBase.typeBlob:
                    if (Blob) {
                        ...
                        this.conten = new Blob([UtilArrayBuffer.stringToArrayBuffer(this.xhr.response)], { type: this.fileMeta.mime });
                    } else {
                ...
                case LoaderBase.typeDocument:
                    // this needs some work, pretty sure there is a better way to handle this
                    this.content = this.xhr.response;
                    break;
