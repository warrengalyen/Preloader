...
var LoaderBase = require('./FileMeta');
...
var LoaderVideo = new Class({
    ...
    _dispatchComplete: function() {
        ...
        this_dispatchProgress(1);
        Class.parent(this);
    },
    _getProgress: function() {
        if (this.content.buffer && this.content.buffer.length > 0 && this.content.buffered.end && this.content.duration) {
